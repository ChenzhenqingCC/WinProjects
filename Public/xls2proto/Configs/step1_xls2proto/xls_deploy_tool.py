...
class LogHelp :
    ...
    def _initlog():
        ...
        logfile = 'zt2_comm_deploy_tool.log'
...
class SheetInterpreter:
    ...
    def __init__(self, xls_file_path, sheet_name):
        ...
        self._row = 0
        self._col = 0
        self._table_name = str(self._sheet.cell_value(1, 0)).upper()
        #print "table_name:" + self._table_name
        ...
        self._pb_file_name = "zt2_deploy_" + self._table_name.lower() + ".proto"
    ...
    def Interpreter(self) :
        ...
        self._output.append("package zt2_deploy;\n")

        self._LayoutStructHead(self._table_name)
    ...
    def _LayoutArray(self) :
        """输出数组定义"""
        self._output.append("message " + self._table_name + "_ARRAY {\n")
        self._output.append("    repeated " + self._table_name + " items = 1;\n}\n")
...
class DataParser:
    ...
    def __init__(self, xls_file_path, sheet_name):
        ...
        try:
            self._module_name = "zt2_deploy_" + self._table_name.lower() + "_pb2"
    ...
    def Parse(self) :
        ...
        item_array = getattr(self._module, self._table_name+'_ARRAY')()
    ...
    def _WriteData2File(self, data) :
        file_name = "zt2_deploy_" + self._table_name.lower() + ".data"
        file = open(file_name, 'wb+')
        file.write(data)
        file.close()

    def _WriteReadableData2File(self, data) :
        file_name = "zt2_deploy_" + self._table_name.lower() + ".txt"
        file = open(file_name, 'wb+')
        file.write(data)
        file.close()
